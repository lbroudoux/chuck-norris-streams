...
public class FilterConfig {
   ...
   public FilterConfig(String bootstrapServers, String rentalsSourceTopic, String moviesSourceTopic,
         String customersSourceTopic, String targetTopic, String trustStorePassword, String trustStorePath,
         String keyStorePassword, String keyStorePath, String username, String password) {
   ...
   public static FilterConfig fromEnv() {
      ...
      String trustStorePassword = System.getenv("TRUSTSTORE_PASSWORD") == null ? null
      ...
      return new FilterConfig(bootstrapServers, rentalsSourceTopic, moviesSourceTopic, customersSourceTopic,
            targetTopic, trustStorePassword, trustStorePath, keyStorePassword, keyStorePath, username, password);

      // return new FilterConfig("localhost:9092", "rental.rentals", "rental.movies",
      // "rental.customers", "rental.chucknorris", trustStorePassword, trustStorePath,
      // keyStorePassword, keyStorePath, username, password);
   }
   ...
   public static Properties getKafkaStreamsProperties(FilterConfig config) {
      ...
      props.put(StreamsConfig.DEFAULT_VALUE_SERDE_CLASS_CONFIG, 
            SerdeFactory.CustomerRentalMovieAggregateSerde().getClass());
