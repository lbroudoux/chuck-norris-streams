...
public class TopologyProducer {
   ...
   public Topology buildTopology() {
      ...
      GlobalKTable<Integer, Customer> usersTableInt = builder.globalTable(config.getCustomersTopic(),
            Consumed.with(defaultIdSerde, userSerde));
      GlobalKTable<Integer, Movie> moviesTableInt = builder.globalTable(config.getMoviesTopic(),
      ...
      KStream<Integer, CustomerRentalMovieAggregate> chuckNorrisRentalsStream = rentalsStream
